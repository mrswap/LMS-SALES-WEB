...
// //     localStorage.setItem("pendingTranslation", lang); // Store pending translation
...
// //           className={`appearance-none bg-white border border-gray-300 rounded-xl px-4 py-2 pr-10 text-sm font-medium shadow-sm hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer ${
...
// //         <FaGlobeAsia className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none" />
// //       </div>
// //     </div>
// //   );
// // };
