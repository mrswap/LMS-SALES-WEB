...
// }) => {
//   const [isVisible, setIsVisible] = useState(true);
//   const [timeLeft, setTimeLeft] = useState(reloadDelay);
//   const [isReloading, setIsReloading] = useState(false);

//   // Auto reload functionality
//   useEffect(() => {
//     if (autoReload && isVisible && !isReloading) {
//       const startTime = Date.now();
//       const endTime = startTime + reloadDelay;
...
//       };
//     }
//   }, [autoReload, isVisible, reloadDelay, isReloading]);
...
//     message || defaultMessages[type] || defaultMessages.error;
...
//   const progressPercentage = (timeLeft / reloadDelay) * 100;
...
//               {autoReload && type === "error" && timeLeft > 0 && (
//                 <div className={`text-xs ${config.textColor} opacity-75 mt-2`}>
//                   Reloading page in {secondsRemaining} second
