...
//   useEffect(() => {
//     if (isOpen) {
//       // Fetch notifications with server-side pagination (5 items per page for dropdown)
//       dispatch(getAllNotifications({ page: currentPage, per_page: 5 }));
//       dispatch(getUnreadCount());
//     }
...
//               {/* Server-side Pagination with Arrow Icons */}
