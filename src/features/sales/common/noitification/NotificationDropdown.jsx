      ...
      >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="relative">
                ...
                {unreadCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-amber-600 text-white text-[10px] font-semibold rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1">
                    {unreadCount}
                  </span>
                )}
              </div>
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="text-xs text-amber-600 hover:text-amber-700 font-medium flex items-center gap-1.5 px-2 py-1 rounded-md hover:bg-amber-50 transition-all duration-200"
              >
                <MdDoneAll size={13} />
              ...
              {currentNotifications.map((notification, index) => (
                <div
                  ...
                  className={`group relative px-5 py-4 cursor-pointer transition-all duration-200 hover:bg-gray-50/80 ${
                    !notification.is_read ? "bg-amber-50/20" : "bg-white"
                  }`}
                >
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-2.5 flex items-center text-amber-600 text-[11px] font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-200 uppercase tracking-wider">
                        Read more
                        <svg
        ...
        <div className="sticky bottom-0 border-t border-gray-100 bg-white shadow-lg">
          <button
            ...
            className="w-full py-3 text-sm font-medium text-amber-600 hover:text-amber-700 hover:bg-amber-50 transition-all duration-200 flex items-center justify-center gap-2"
          >
