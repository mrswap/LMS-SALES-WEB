...
//     { name: t("footer.privacy"), url: data.privacy_policy },
//     { name: t("footer.terms"), url: data.terms_conditions },
//   ];
...
//             {/* <p className="ml-3 text-gray-300">{t("footer.loading")}</p> */}
//           </div>
//         </div>
//       </footer>
//     );
