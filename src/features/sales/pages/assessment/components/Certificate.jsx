        ...
        <div className="flex flex-wrap items-center gap-3">
          {share_links?.linkedin && (
            <button
              ...
              className="flex items-center gap-2 px-5 py-2 text-sm font-medium text-blue-700  border border-blue-700 rounded-md cursor-pointer "
            >
              <FaLinkedin size={15} className="text-blue-600" /> Share to
              LinkedIn
            </button>
          )}
          <button
            onClick={handleDownload}
            className="flex items-center gap-2 px-5 py-2 text-sm font-medium text-white bg-blue-700 rounded-sm cursor-pointer "
          >
            ...
            >
              ...
              <div className="p-10 print:p-8 relative z-10">
                ...
                {design?.heading && (
                  <div className="text-center mb-4">
                    ...
                    <div className="flex justify-center items-center gap-2 mt-0.5">
                      ...
                      <p className="text-xs text-emerald-600">of Achievement</p>
                      <FaMedal className="text-emerald-600 text-sm" />
                    </div>
                  </div>
                )}
                ...
                <div className="text-center my-4">
                  <p className="text-gray-600 text-xs">Presented To</p>
                  <div className="my-3">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    ...
                    <div className="border-x border-emerald-200">
                      <div className="text-2xl font-serif font-bold text-emerald-800 capitalize">
                        {result?.status === "passed" ? "Passed" : "Completed"}
                      </div>
                      <div className="text-[9px] text-gray-500 uppercase tracking-wider">
                        Status
                      </div>
                ...
                <div className="grid grid-cols-2 gap-6 mt-4 pt-3">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-500">
                      {design?.signer_designation || "Authorized Signatory"}
                    </p>
                  </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="px-3 py-2">
              <div className="grid grid-cols-2 gap-1 text-xs">
                <div>
                  <span className="text-gray-400 text-[9px]">Name</span>
                  <p className="font-medium text-gray-800 text-xs">
                    {user?.name || "-"}
                  </p>
                </div>
                <div>
                  <span className="text-gray-400 text-[9px]">Employee ID</span>
                  <p className="font-medium text-gray-800 text-xs">
                    {user?.employee_id || "-"}
                  </p>
                </div>
                <div className="col-span-2">
                  <span className="text-gray-400 text-[9px]">Email</span>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="px-3 py-2">
                <div className="space-y-1 text-xs">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-400 text-[9px]">Percentage</span>
                    <span className="font-medium text-gray-800">
                      {result?.percentage || 0}%
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400 text-[9px]">Passing</span>
                    <span className="font-medium text-gray-800">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="px-3 py-2">
                <div className="space-y-1 text-xs">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-400 text-[9px]">Attempted</span>
                    <span className="font-medium text-gray-800">
                      {questions?.attempted || 0}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400 text-[9px]">Correct</span>
                    <span className="font-medium text-green-600">
                      {questions?.correct || 0}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400 text-[9px]">Incorrect</span>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="px-3 py-2">
              <div className="grid grid-cols-3 gap-1 text-xs">
                <div>
                  <span className="text-gray-400 text-[9px]">Started</span>
                  <p className="font-medium text-gray-800 text-[10px]">
                    {formatDate(time?.started_at)}
                  </p>
                </div>
                <div>
                  <span className="text-gray-400 text-[9px]">Submitted</span>
                  <p className="font-medium text-gray-800 text-[10px]">
                    {formatDate(time?.submitted_at)}
                  </p>
                </div>
                <div>
                  <span className="text-gray-400 text-[9px]">Time Taken</span>
                  <p className="font-medium text-gray-800 text-[10px]">
                ...
                <div className="col-span-3">
                  <span className="text-gray-400 text-[9px]">Attempt #</span>
                  <p className="font-medium text-gray-800 text-[10px]">
                    {attempt?.attempt_id || "-"}
                  </p>
                </div>
            ...
            <div className="px-3 py-2">
              <div className="grid grid-cols-2 gap-x-3 gap-y-0.5 text-xs">
                <div className="flex justify-between col-span-2">
                  <span className="text-gray-400 text-[9px]">Program</span>
                ...
                <div className="flex justify-between col-span-2">
                  <span className="text-gray-400 text-[9px]">Module</span>
                  <span className="font-medium text-gray-800 text-[10px] truncate max-w-[140px]">
                    {context_details?.module?.title || "-"}
                  </span>
                </div>
                <div className="flex justify-between col-span-2">
                  <span className="text-gray-400 text-[9px]">Chapter</span>
                  <span className="font-medium text-gray-800 text-[10px] truncate max-w-[140px]">
                    {context_details?.chapter?.title || "-"}
                  </span>
                </div>
                <div className="flex justify-between col-span-2">
                  <span className="text-gray-400 text-[9px]">Topic</span>
