        ...
        <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 modal-allowed">
          ...
          <div className="p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 text-center mb-2">
              {t("examModule.confirmationModal.title")}
            </h3>
            <p className="text-gray-600 text-center mb-6">
              {t("examModule.confirmationModal.description")}
              <span className="block mt-2 text-sm text-orange-600 font-medium">
                {t("examModule.confirmationModal.progressSaved")}
              </span>
            </p>
            {timeLeft > 0 && !isTimeUp && (
              <div className="mb-6 p-3 bg-gray-50 rounded-lg text-center">
                <span className="text-sm text-gray-600">
                  {t("examModule.confirmationModal.timeRemaining")}{" "}
                </span>
            ...
            <div className="flex gap-3">
              ...
              >
                {t("examModule.confirmationModal.cancel")}
              </button>
              <button
                onClick={onConfirm}
              ...
              >
                {t("examModule.confirmationModal.confirm")}
              </button>
            </div>
          </div>
        </div>
