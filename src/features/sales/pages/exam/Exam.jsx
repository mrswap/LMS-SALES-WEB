...
//             nav(`/exam/results/${attemptRef.current.attempt_id}`);
//           } else {
//             nav(-1);
//           }
//         }
...
//               </div>
//               <div>
//                 <PageTitle>No Attempts Left</PageTitle>
//                 <PageSubtitle>
//                   You have exhausted all your attempts for this exam
//                 </PageSubtitle>
//               </div>
//             </div>
//           </PageHeaderLeft>
...
//                 You have used all {attempt.total_attempts_allowed} attempt(s)
//                 for this exam.
//               </p>
//               <button
//                 onClick={() => navigate(-1)}
...
//                 <PageSubtitle>
//                   Test your understanding with this exam
//                 </PageSubtitle>
//               </div>
//             </div>
//           </PageHeaderLeft>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4">
          ...
          <div className="p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 text-center mb-2">
              {t("exam.confirmationModal.title")}
            </h3>
            <p className="text-gray-600 text-center mb-6">
              {t("exam.confirmationModal.description")}
              <span className="block mt-2 text-sm text-orange-600 font-medium">
                {t("exam.confirmationModal.progressSaved")}
              </span>
            </p>
            {timeLeft > 0 && !isTimeUp && (
              <div className="mb-6 p-3 bg-gray-50 rounded-lg text-center">
                <span className="text-sm text-gray-600">
                  {t("exam.confirmationModal.timeRemaining")}{" "}
                </span>
                <span className="font-mono font-bold text-blue-600">
                  {formatTime(timeLeft)}
                </span>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-2.5 border-2 border-gray-300 rounded-xl text-gray-700 font-medium hover:bg-gray-50 hover:border-gray-400 transition-all"
              >
                {t("exam.confirmationModal.cancel")}
              </button>
              <button
                onClick={onConfirm}
                className="flex-1 px-4 py-2.5 bg-orange-600 text-white rounded-xl font-medium hover:bg-orange-700 transition-all shadow-md hover:shadow-lg"
              >
                {t("exam.confirmationModal.confirm")}
              </button>
            </div>
          </div>
        </div>
        ...
        <PageHeader>
          <PageHeaderLeft>
            <div className="flex items-center gap-3">
              ...
              <div>
                <PageTitle>{t("exam.noAttemptsTitle")}</PageTitle>
                <PageSubtitle>{t("exam.noAttemptsSubtitle")}</PageSubtitle>
              </div>
            </div>
          </PageHeaderLeft>
        </PageHeader>
        <PageBody>
          <div className="max-w-3xl mx-auto px-4">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
              <FiAlertCircle className="w-16 h-16 text-red-400 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-gray-800 mb-2">
                {t("exam.noAttemptsHeading")}
              </h3>
              <p className="text-gray-600 mb-6">
                {t("exam.noAttemptsMessage", {
        ...
        <PageHeader>
          <PageHeaderLeft>
            <div className="flex items-center gap-3">
              ...
              <div>
                <PageTitle>{t("exam.pageTitle")}</PageTitle>
                <PageSubtitle>{t("exam.pageSubtitle")}</PageSubtitle>
              </div>
            </div>
          </PageHeaderLeft>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <FiLogOut className="w-4 h-4" />
              <span className="text-sm font-medium">{t("exam.exitExam")}</span>
            </button>
          </div>
        </PageHeader>
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-gray-800">
                        {attempt.duration} {t("exam.minutes")}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <FiClock className="w-4 h-4 text-gray-500" />
