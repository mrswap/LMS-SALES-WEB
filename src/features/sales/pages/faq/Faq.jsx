...
const Faq = () => {
  ...
  return (
    <PageLayout>
      <PageHeader>
        <PageHeaderLeft>
          <PageTitle>{t("faq.pageTitle")}</PageTitle>
          <PageSubtitle>{t("faq.pageSubtitle")}</PageSubtitle>
        </PageHeaderLeft>
        <PageHeaderRight />
      </PageHeader>
      ...
      <PageBody>
        {faqsList && faqsList.length > 0 ? (
                  ...
                  <div className="px-6 pb-6 pt-2 border-t border-gray-100">
                    ...
                    {faq.image && (
                      <div className="mb-5 pl-10">
                        <img
                          src={faq.image}
                          alt={`${t("faq.illustrationFor")} ${faq.question}`}
                          className="rounded-lg max-w-full h-auto max-h-64 object-contain border border-gray-200"
                          loading="lazy"
                          onError={(e) => {
                            e.target.style.opacity = "0";
          ...
          <div className="text-center py-16 px-4">
            ...
            <p className="text-gray-500 text-lg">{t("faq.emptyState.title")}</p>
            <p className="text-gray-400 text-sm mt-2">
              {t("faq.emptyState.description")}
            </p>
          </div>
        )}
      </PageBody>
