...
//   return (
//     <div className="group bg-white rounded-2xl overflow-hidden border border-gray-300 shadow-sm ">
//       {/* Image */}
...
//           }}
//           className="mt-3 w-full py-2.5 rounded-xl text-sm font-medium transition bg-blue-400 text-white hover:bg-blue-500 flex items-center justify-center gap-2"
//         >
    ...
    <div className="group bg-white rounded-2xl overflow-hidden border border-gray-300 shadow-sm ">
      ...
      <div className="p-4">
        ...
        <button
          ...
          disabled={status === t("levelsPage.status.locked")}
          className={`mt-3 w-full py-2.5 rounded-xl text-sm font-medium transition 
            ${
              status === t("levelsPage.status.locked")
                ? "bg-gray-200 text-gray-500 cursor-not-allowed"
                : status === t("levelsPage.status.running")
