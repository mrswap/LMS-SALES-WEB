...
const levelsData = [
  {
    ...
    status: "COMPLETED",
    button: "Take an Exam",
    img: "https://images.unsplash.com/photo-1581090700227-1e8c1f8f0c0d",
  },
  {
    id: 2,
...
const LevelCard = ({ item }) => {
  ...
  return (
    <div
      onClick={() => navigate(`/levels/${item.id}`)} // 🔥 yaha navigation
    ...
    >
      ...
      <div className="p-4">
        ...
        {/* 🔥 important: button click card ko trigger na kare */}
        <button
          onClick={(e) => e.stopPropagation()}
          className={`mt-4 w-full py-2 rounded-lg text-sm font-medium ${buttonStyles[item.status]}`}
