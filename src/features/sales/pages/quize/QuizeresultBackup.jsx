...
//           {/* ── Thank-you card (NO AUTO-REDIRECT) ── */}
//           {feedbackSubmitted && (
//             <div
//               className="relative rounded-2xl overflow-hidden text-center px-8 py-12 animate-[thankPop_.6s_cubic-bezier(.22,.68,0,1.2)_both]"
//               style={{
...
//               {/* Home button instead of auto-redirect */}
//               <button
//                 onClick={handleGoHome}
...
//           {/* ── Action Buttons (only shown when feedback NOT submitted) ── */}
//           {!feedbackSubmitted && (
//             <div className="flex gap-4 justify-center animate-[fadeUp_.5s_ease_.45s_both]">
//               <button
//                 onClick={handleGoHome}
          ...
          {!feedbackSubmitted && (
            <div className="flex gap-4 justify-center flex-wrap animate-[fadeUp_.5s_ease_.45s_both]">
              ...
              {canRetry && (
                ...
                >
                  <FiRefreshCw className="w-3.5 h-3.5" />
                  {t("quizResult.buttons.retry")} ({attemptsRemaining} attempts
                  left)
                </button>
              )}
            </div>
