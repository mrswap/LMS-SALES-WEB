...
//             >
//               <HiSpeakerWave className="text-xl text-gray-700" />
//             </button>
//           )}
//         </div>
//         <PageBody className="mt-4">
//           {/* PageBody ke andar first div ke top pe ye add karo */}
//           {showAudioPlayer && content?.audio_content && (
//             <div className="mb-6 rounded-2xl border border-gray-200 bg-gradient-to-r from-white to-gray-50 shadow-md overflow-hidden">
//               <div className="flex items-center gap-4 p-5">
//                 <button
//                   onClick={toggleAudio}
//                   className="w-14 h-14 rounded-full bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center shadow-md transition"
//                 >
...
//                   >
//                     <source src={content?.audio_content} type="audio/mpeg" />
//                   </audio>
//                 </div>
//               </div>
//             </div>
